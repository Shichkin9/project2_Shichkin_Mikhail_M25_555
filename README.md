...
# Собрать и протестировать пакет
make build
make publish

Особенности реализации

    Данные сохраняются в JSON-файл (db_meta.json) для персистентности

    Автоматическое добавление колонки ID:int при создании таблицы

    Валидация типов данных и уникальности имён таблиц

    Безопасный парсинг команд через shlex

Требования

    ОС: Ubuntu/Debian или другой Linux-дистрибутив
...
Учебный проект по разработке Python-пакетов и консольных приложений
